...
local keyboardIdentifier = '1856D988' --'0000AAA'
...
if keyboardIdentifier == '1856D988' then
...
sendToAHK = function (key)
      ...
      local file = io.open("D:\\Other\\Hotkeys\\Lua Macros\\keys\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
