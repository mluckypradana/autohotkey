...
Return
useBlack(){
	MouseClick Left, 180, 537
}
useGray(){
	MouseClick Left, 207, 555
}
useRed(){
	MouseClick Left, 206, 607
}
useGreen(){
	MouseClick Left, 181, 602
}
useBlue(){
	MouseClick Left, 229, 525
}
useYellow(){
	MouseClick Left, 182, 654
}
useCyan(){
	MouseClick Left, 228, 553
}
useMagenta(){
